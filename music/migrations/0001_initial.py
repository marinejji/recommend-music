# Generated by Django 2.2.1 on 2024-01-07 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director', models.CharField(max_length=255, verbose_name='歌手名称')),
                ('country', models.CharField(max_length=255, verbose_name='地区')),
                ('years', models.DateField(verbose_name='上架日期')),
                ('leader', models.CharField(max_length=1024, verbose_name='歌曲评分')),
                ('d_rate_nums', models.IntegerField(verbose_name='评价数')),
                ('d_rate', models.CharField(max_length=255, verbose_name='歌曲评分')),
                ('intro', models.TextField(verbose_name='描述')),
                ('num', models.IntegerField(default=0, verbose_name='歌曲浏览量')),
