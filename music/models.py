...
class Movie(models.Model):
    ...
    director = models.CharField(verbose_name="歌手名称", max_length=255)
    country = models.CharField(verbose_name="地区", max_length=255)
    years = models.DateField(verbose_name='上架日期')
    leader = models.CharField(verbose_name="歌曲评分", max_length=1024)
    d_rate_nums = models.IntegerField(verbose_name="评价数")
    d_rate = models.CharField(verbose_name="歌曲评分", max_length=255)
    intro = models.TextField(verbose_name="描述")
    num = models.IntegerField(verbose_name="歌曲浏览量", default=0)
...
class Rate(models.Model):
    ...
    mark = models.FloatField(verbose_name="歌曲评分")
